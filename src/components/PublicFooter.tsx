...
export default function PublicFooter() {
  const socialLinks = [
    {
      href: "https://linkedin.com/company/dwsafrica",
      label: "DWSA on LinkedIn",
      icon: LinkedinIcon,
      name: "LinkedIn",
    },
    {
      href: "https://facebook.com/dwsafrica",
      label: "DWSA on Facebook",
      icon: FacebookIcon,
      name: "Facebook",
    },
    {
      href: "https://twitter.com/dwsafrica",
      label: "DWSA on X (Twitter)",
      icon: TwitterIcon,
      name: "X (Twitter)",
    },
    {
      href: "https://instagram.com/dwsafrica",
      label: "DWSA on Instagram",
      icon: InstagramIcon,
      name: "Instagram",
    },
    {
      href: "https://youtube.com/@dwsafrica",
